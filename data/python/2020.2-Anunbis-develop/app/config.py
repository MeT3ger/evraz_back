...
# TODO: Необходимо использовать pydantic модели, настройки должны быть в .env,
#  настройки должны быть отнесенны к модулям к которым они относятся они относятся
class BaseConfig:
    TITLE = "Anunbis"
    JSON_AS_ASCII = False
    MAIL_DEBUG = True

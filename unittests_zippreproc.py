import unittest
from zip_preproc import ZipPreproc
...
class TestZipPreproc(unittest.TestCase):
    ...
    def test_find_file_types(self):
        ...
        #1 Тест с Anunbis-develop.zip
        res_func = self.test_file_1.find_file_types()
        ...
        #2 Тест с backend-master.zip
        res_func = self.test_file_2.find_file_types()
        ...
        #3 Тест с donna-backend-master.zip
        res_func = self.test_file_3.find_file_types()
        ...
        #4 Тест с final-year-project-backend-api-master.zip
        res_func = self.test_file_4.find_file_types()
        ...
        #5 Тест с Flask-PostgreSQL-API-Seed-master.zip
        res_func = self.test_file_5.find_file_types()
        ...
        #6 Тест с FlaskApiEcommerce-master.zip
        res_func = self.test_file_6.find_file_types()
        ...
        #7 Тест с gramps-web-api-master.zip
        res_func = self.test_file_7.find_file_types()
        ...
        #8 Тест с hackernews-api-main.zip
        res_func = self.test_file_8.find_file_types()
        ...
        #9 Тест с http-api.zip
        res_func = self.test_file_9.find_file_types()
        ...
        #10 Тест с luncher-api-master.zip
        res_func = self.test_file_10.find_file_types()
        ...
        #11 Тест с ml-flask-api-master.zip
        res_func = self.test_file_11.find_file_types()

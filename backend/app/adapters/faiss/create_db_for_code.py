...
class FAISSManager:
    ...
    def add_documents_from_json(self, json_data, path=""):
        ...
        for key, value in json_data.items():
            ...
            if isinstance(value, dict):
                self.add_documents_from_json(value, current_path)
                ...
                if current_path.endswith('.py'):
                    ...
                    for chunk in chunks:
                        ...
                        if not self.is_duplicate(new_embedding):
    ...
    def is_duplicate(self, new_embedding, threshold=0.9):
    ...
    async def similarity_search(self, query: str, k=10):
